...
class SantoriniGame(Game):
    ...
    def getNextState(self, board, player, action):
        ...
        action_build = (action_move[0] + action_build[0],
                        action_move[1]+action_build[1])
...
#            print(l)
    ...
    def getCanonicalForm(self, board, player):
        ...
        board = board * np.append(np.ones((1, self.n, self.n), dtype='int')
                                  * player, np.ones((1, self.n, self.n), dtype='int'), axis=0)
